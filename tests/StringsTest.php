...
class MyCarbon extends IntlCarbon
{
}
...
class StringsTest extends TestFixture
{
    ...
    {
        $d = IntlCarbon::now();
        $this->assertSame(IntlCarbon::now()->toDateTimeString(), ''.$d);
    }
    public function testSetToStringFormat()
    {
        IntlCarbon::setToStringFormat('jS \o\f F, Y g:i:s a');
    ...
    {
        $d = IntlCarbon::create(1975, 12, 25, 14, 15, 16, 'Europe/London');
    ...
    {
        $d = IntlCarbon::create(2000, 5, 2, 4, 3, 4);
