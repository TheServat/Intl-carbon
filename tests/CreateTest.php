...
class CreateTest extends TestFixture
{
    ...
    public function testCreateWithInvalidYear()
    {
        ...
        $d = IntlCarbon::create(-3);
    }

    public function testCreateWithMonth()
    {
        $d = IntlCarbon::create(null, 3);
    ...
    {
        $this->setExpectedException('InvalidArgumentException');
        $d = IntlCarbon::create(null, -5);
    }

    public function testCreateMonthWraps()
    {
        $d = IntlCarbon::create(2011, 0, 1, 0, 0, 0);
        $this->assertIntlCarbon($d, 2010, 12, 1, 0, 0, 0);
    }

    public function testCreateWithDay()
    {
        $d = IntlCarbon::create(null, null, 21);
    ...
    {
        $this->setExpectedException('InvalidArgumentException');
        $d = IntlCarbon::create(null, null, -4);
    }
    public function testCreateDayWraps()
    {
        $d = IntlCarbon::create(2011, 1, 40, 0, 0, 0);
        $this->assertIntlCarbon($d, 2011, 2, 9, 0, 0, 0);
    }

    public function testCreateWithHourAndDefaultMinSecToZero()
    {
        $d = IntlCarbon::create(null, null, null, 14);
    ...
    {
        $this->setExpectedException('InvalidArgumentException');
        $d = IntlCarbon::create(null, null, null, -1);
    }

    public function testCreateHourWraps()
    {
        $d = IntlCarbon::create(2011, 1, 1, 24, 0, 0);
        $this->assertIntlCarbon($d, 2011, 1, 2, 0, 0, 0);
    }

    public function testCreateWithMinute()
    {
        $d = IntlCarbon::create(null, null, null, null, 58);
    ...
    {
        $this->setExpectedException('InvalidArgumentException');
        $d = IntlCarbon::create(2011, 1, 1, 0, -2, 0);
    }
    public function testCreateMinuteWraps()
    {
        $d = IntlCarbon::create(2011, 1, 1, 0, 62, 0);
        $this->assertIntlCarbon($d, 2011, 1, 1, 1, 2, 0);
    }

    public function testCreateWithSecond()
    {
        $d = IntlCarbon::create(null, null, null, null, null, 59);
    ...
    {
        $this->setExpectedException('InvalidArgumentException');
        $d = IntlCarbon::create(null, null, null, null, null, -2);
    }
    public function testCreateSecondsWrap()
    {
        $d = IntlCarbon::create(2012, 1, 1, 0, 0, 61);
        $this->assertIntlCarbon($d, 2012, 1, 1, 0, 1, 1);
    }

    public function testCreateWithDateTimeZone()
    {
        $d = IntlCarbon::create(2012, 1, 1, 0, 0, 0, new \DateTimeZone('Europe/London'));
